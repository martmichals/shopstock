...
class _MapExploreState extends State<MapExplore> {
  ...
  Marker _storeToMarker(Store store) {
    ...
    return Marker(
      ...
      position: location,
      infoWindow: InfoWindow(title: store.storeName, onTap: _onMarkerTap),
    );
  }
  ...
  Widget build(BuildContext context) {
    var _tempMarkers = <Marker>[
      Marker(
        ...
        infoWindow: InfoWindow(title: "Whole Foods", onTap: _onMarkerTap),
      ),
      Marker(
        markerId: MarkerId("1"),
        position: new LatLng(41.892316, -87.628676),
        infoWindow: InfoWindow(title: "Jewel Osco", onTap: _onMarkerTap),
      ),
      Marker(
        markerId: MarkerId("2"),
        position: new LatLng(41.893514, -87.626310),
        infoWindow: InfoWindow(title: "Trader Joes", onTap: _onMarkerTap),
      ),
    ];
